    ...
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="{{ route('register') }}" class="pt-8">
            ...
            <div class="relative">
                ...
                <div>
                    <input id="name" placeholder="Your Name" type="text" class="pt-8 pl-3 w-full rounded pt-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="name" value="{{ old('name') }}" autocomplete="name" autofocus>
            ...
            <div class="relative pt-3">
                ...
                <div>
                    <input id="email" placeholder="your@email.com" type="email" class="pt-8 pl-3 w-full rounded pt-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" autocomplete="email">
            ...
            <div class="relative pt-3">
                ...
                <div>
                    <input id="password" placeholder="Password" type="password" class="pt-8 pl-3 w-full rounded pt-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password" autocomplete="new-password">
            ...
            <div class="relative pt-3">
                ...
                <div>
                    <input id="password-confirm" placeholder="Confirm" type="password" class="pt-8 pl-3 w-full rounded pt-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password_confirmation" autocomplete="new-password">
                </div>
            </div>

            <div class="pt-8">
                <button type="submit"
                        class="w-full text-blue-800 text-left bg-gray-400 py-2 px-3 uppercase rounded text-gray-100 font-bold">
                    Register
                </button>
            </div>
