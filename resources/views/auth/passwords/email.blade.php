    ...
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="{{ route('password.email') }}" class="pt-8">
            ...
            <div class="relative">
                ...
                <div>
                    <input id="email" placeholder="your@email.com" type="email" class="pt-8 pl-3 w-full rounded pt-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" autocomplete="email" autofocus>
