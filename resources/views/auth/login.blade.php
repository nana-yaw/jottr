    ...
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            ...
            <div class="relative">
                ...
                <div>
                    <input id="email" type="email" class="pt-8 pl-3 w-full rounded pt-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" autocomplete="email" autofocus placeholder="your@email.com">
            ...
            <div class="relative pt-3">
                ...
                <div>
                    <input id="password" type="password" placeholder="Password" class="pt-8 pl-3 w-full rounded pt-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password" autocomplete="current-password">
