    ...
    <div>
        ...
        <div v-else>
            <div class="flex justify-between">
                    ...
                    <div class="relative">
                        <router-link class="mr-2 px-4 py-2 rounded text-sm text-green-500 border border-green-500 font-bold" :to="'/contacts/' + contact.contact_id + '/edit'">Edit</router-link>
                        <a href="#" @click="modal = !modal" class="px-4 py-2 text-red-500 border border-red-500 rounded text-sm font-bold">Delete</a>
