    ...
    <div class="h-screen bg-white">
        <div class="flex">
            <div class="bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    <router-link to="/">
                        <svg class="fill-current pl-6 text-blue-600 w-16 h-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <p class="pt-12 px-6 text-gray-500 text-xs uppercase font-bold">
                        Create
                    </p>

                    <router-link to="/contacts/create" class="flex items-center text-sm px-6 py-2 hover:text-blue-600" >

                        <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-5 h-5"><path d="M23.3 11.9c0 .9-.6 1.4-1.4 1.4h-8.5v8.5c0 .9-.6 1.4-1.4 1.4s-1.4-.6-1.4-1.4v-8.5H2c-.9 0-1.4-.6-1.4-1.4 0-.9.6-1.4 1.4-1.4h8.5V1.9c0-.9.6-1.4 1.4-1.4s1.4.6 1.4 1.4v8.5h8.5c.9 0 1.5.6 1.5 1.5z"/>
                        </svg>
                    ...
                    <router-link to="/contacts" class="flex items-center text-sm px-6 py-2 hover:text-blue-600" >
                    ...
                    <router-link to="/birthdays" class="flex items-center text-sm px-6 py-2 hover:text-blue-600" >
                    ...
                    <router-link to="/logout" class="flex items-center text-sm px-6 py-2 hover:text-blue-600" >
...
<script>
    ...
    export default {
        ...
        watch: {
            ...
            title() {
                document.title = this.title + ' | Jottr - The SPA App'
            }
        },
    }
</script>
